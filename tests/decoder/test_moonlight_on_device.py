...
@skip_no_model
@pytest.mark.skipif(COMPILED_PATH is not None, reason="save/reload requires export() path, not pre-compiled model")
@is_inferentia_test
@requires_neuronx
def test_save_and_reload(neuron_model):
    with TemporaryDirectory() as tmpdir:
        neuron_model.save_pretrained(tmpdir)
